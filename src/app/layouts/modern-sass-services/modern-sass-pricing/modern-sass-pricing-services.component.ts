...
@Component({
  selector: 'app-modern-sass-pricing-services',
  templateUrl: './modern-sass-pricing-services.component.html',
  styleUrls: ['./modern-sass-pricing-services.component.scss']
})
export class ModernSassPricingServiceComponent implements OnInit {
  ...
  pricing = [
    ...
    {
      img:"assets/images/yoga-img/abs-yoga.png",
      package:"Why Growk is you perfetc partner",
