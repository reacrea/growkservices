...
@Component({
  selector: 'app-modern-sass-feature-services',
  templateUrl: './modern-sass-feature-services.component.html',
  styleUrls: ['./modern-sass-feature-services.component.scss']
})
export class ModernSassFeatureServiceComponent implements OnInit {
